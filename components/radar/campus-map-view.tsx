    ...
    <div className="space-y-4">
      <Card className="border border-zinc-200 dark:border-zinc-800 shadow-md overflow-hidden bg-zinc-950 text-white relative">
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="relative w-full aspect-[16/10] max-h-[480px] rounded-xl bg-zinc-900/90 border border-zinc-800 overflow-hidden flex items-center justify-center p-4">
